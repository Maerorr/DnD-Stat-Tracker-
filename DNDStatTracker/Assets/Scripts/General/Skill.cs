    ...
    public static Skills Default()
    {
        return new Skills
        {
            skills = new Dictionary<string, Skill>
            {
                ...
                {"Perception", new Skill(StatType.Wisdom, SkillType.Perception, false, false, 0)},
                {"Performance", new Skill(StatType.Charisma, SkillType.Performance, false, false, 0)},
                {"Persuasion", new Skill(StatType.Charisma, SkillType.Persuasion, false, false, 0)},
